...
required_files = {'bert.py', 'optimizer.py', 'classifier.py', 'sst-dev-output_pretrain.txt', 'sst-test-output_pretrain.txt', 'cfimdb-dev-output_pretrain.txt', 'cfimdb-test-output_pretrain.txt',
                    'sst-dev-output_finetune.txt', 'sst-test-output_finetune.txt', 'cfimdb-dev-output_finetune.txt', 'cfimdb-test-output_finetune.txt'}
